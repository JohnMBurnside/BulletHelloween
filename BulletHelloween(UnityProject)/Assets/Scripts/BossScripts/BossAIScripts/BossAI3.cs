...
public class BossAI3 : MonoBehaviour
{
    /// <summary>
    /// ~Reaper Boss
    ///     -This will be the third boss with the same amount of health as the second and more or less the same diffucluty level
    ///     -Mechanics:
    ///         -The boss will spawn 4 shadow versions of himself everytime his health goes down a quarter(1/4)
    ///         -You'll have to kill all 4 shadow bosses to move on(10 health each)
    ///         -In total you'll go through 12 shadow bosses
    ///     -Waves(Boss):
