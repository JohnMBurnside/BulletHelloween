...
using UnityEngine;
public class FinalShadeBossAI : MonoBehaviour
{
    /// <summary>
    /// ~Shade Reaper Boss
    /// </summary>
    ...
    public int health = 25;                                         //Health for shade boss
    ...
    void Start()
    {
        ...
        boss = GameObject.FindGameObjectWithTag("FinalBoss").gameObject;
    }
    //UPDATE FUNCTION
    void Update()
    {
        ...
        if (health < 1)
        {
            boss.GetComponent<BossAI4>().shadeKill++;
            Destroy(gameObject);
        }
    }
    //TRIGGER FUNCTION
