...
public class BossAI1 : MonoBehaviour
{
    /// <summary>
    /// ~Skeleton Boss
    ///     -This boss will be the first boss and will be easy
    ///     -Waves:
    ///         -First wave will simply shoot
    ///         -Second wave will do the first and second pattern
    ///         -Third wave will simply shoot again
    ///         -Fourth and final wave will do the patterns and shoot
    ///         -Repeat
    /// </summary>
    //VARIABLES														//VARIABLES
